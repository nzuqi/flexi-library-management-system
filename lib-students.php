<?php
	...
	if (!$user->login_check($mysqli)){
		...
		<div class="container">
			...
			?>
			<h1 class="text-danger" style="margin-top:0;"><span class="glyphicon glyphicon-user"></span> Students & Staff</h1>
			<?php
			if (!isset($_GET["staff"])){
				...
				while ($row=mysqli_fetch_array($res)){
					if ($row[0]==0){	//no students found
						...
						<ul class="nav nav-tabs">
							<li class="nav-item <?php if (!isset($_GET["staff"])){ echo "active"; } ?>"><a href="lib-students" class="nav-link"><strong>STUDENTS</strong></a></li>
							<li class="nav-item <?php if (isset($_GET["staff"])){ echo "active"; } ?>"><a href="lib-students?staff" class="nav-link"><strong>STAFF</strong></a></li>
						</ul>
						<p>&nbsp;</p>
						<?php 
						if (!isset($_GET["staff"])){
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									<div class="modal-header">
										...
										<?php
										if (!isset($_GET["staff"])){
											?><h4 class="modal-title">Export Students Records</h4><?php
										}
										else{
											?><h4 class="modal-title">Export Staff Records</h4><?php
										}
										?>
									</div>
									<?php
									if (!isset($_GET["staff"])){
										?>
										<form action="lib-students-export" method="POST">
											<div class="modal-body">
												<p>&nbsp;</p>
												<div class="radio"><label><input type="radio" name="dtype" id="dtype" value="student" checked /> Download All Students Records (MS Excel File)</label></div>
												<p>&nbsp;</p>
											</div>
										...
										?>
										<form action="lib-students-export?staff" method="POST">
											<div class="modal-body">
												<p>&nbsp;</p>
												<div class="radio"><label><input type="radio" name="dtype" id="dtype" value="staff" checked /> Download All Staff Records (MS Excel File)</label></div>
												<p>&nbsp;</p>
											</div>
											<div class="modal-footer"> 
												<button type="submit" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-download-alt"></i> Download</button>
