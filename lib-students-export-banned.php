<?php
	...
	if ($_SERVER["REQUEST_METHOD"]=="POST"){
		...
		if ($dtype=='staff')
			$sql = mysql_query("SELECT * FROM libcusts WHERE LType='staff' AND LBan=1 ORDER BY LName ASC");
		else
			$sql = mysql_query("SELECT * FROM libcusts WHERE LType='student' AND LBan=1 ORDER BY LName ASC");
		$n = 1;
